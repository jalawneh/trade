...
OPENAI_API_KEY = "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"
...
def call_openai_chat(prompt):
    ...
    try:
        ...
        if r.status_code == 401:
            return ""  # silently ignore 401 Unauthorized
        return ""  # ignore other HTTP errors silently
    except Exception:
        return ""  # suppress all other errors
...
# --- Run Button ---
run_scan = st.sidebar.button("🔍 Run Market Scan")
...
def scan_market():
    ...
    def get_ai_analysis(row):
        return "", 0  # Replace this line if re-enabling OpenAI scoring

    ai_results = [("", 0)] * len(df)  # Bypass API call to avoid 401 errors
